...
const mockUseLocalAudioToggle = useLocalAudioToggle as jest.Mock<
    [boolean, Function]
>;

xdescribe('the ToggleAudioButton component', () => {
    it('should render correctly when audio is enabled', () => {
        mockUseLocalAudioToggle.mockImplementation(() => [true, jest.fn()]);
        const wrapper = shallow(<ToggleAudioButton disabled={false} />);
    ...
    it('should render correctly when audio is disabled', () => {
        mockUseLocalAudioToggle.mockImplementation(() => [false, jest.fn()]);
        const wrapper = shallow(<ToggleAudioButton disabled />);
