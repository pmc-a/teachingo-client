...
import { VideoContextInterface } from '../VideoProvider';
...
const mockedUseVideoContext = useVideoContext as jest.Mock<
...
Object.defineProperty(window, 'location', {
    value: { pathname: '', configurable: true },
});
...
describe('the MenuBar component', () => {
    ...
    it('should hide inputs when connected to a room', () => {
        ...
        mockedUseVideoContext.mockImplementation(
            () => ({ isConnecting: false, room: {} } as any)
        );
